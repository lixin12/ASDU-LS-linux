...
__attribute__((section("__versions"))) = {
	...
	{ 0x63199be9, __VMLINUX_SYMBOL_STR(skb_realloc_headroom) },
	...
	{ 0x4adc7b97, __VMLINUX_SYMBOL_STR(gether_get_host_addr_u8) },
	...
	{ 0x9a398695, __VMLINUX_SYMBOL_STR(dev_get_stats) },
};
