...
__attribute__((section("__versions"))) = {
	...
	{ 0x4ea708a3, __VMLINUX_SYMBOL_STR(device_create_file) },
	{ 0xf5201c98, __VMLINUX_SYMBOL_STR(dev_notice) },
